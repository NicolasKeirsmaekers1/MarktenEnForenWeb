...
export class BeheerVariabelenComponent {
  ...
  fetchData(): void {
    ...
    switch (this.code) {
      case 'locatie':
        this.locatieService.getLocaties(true).subscribe(
          (x) => {
            this.data = x;
            this.data.forEach((y) => {
      ...
      case 'product':
        ...
        this.productService.getProducten(filter).subscribe(
          (x) => {
            this.data = x;
            this.data.forEach((y) => {
              ...
              group.addControl(
                'geldigVan',
                this.fb.control((<any>y).geldigVan)
              );
              group.addControl(
                'geldigTot',
                this.fb.control((<any>y).geldigTot)
              );
              (<FormArray>this.codesForm.get('codes')).push(group);
            });
          },
        ...
        break;
      case 'standplaatsTarief':
        this.tariefService.getStandplaatsTarieven().subscribe(
          (x) => {
            this.data = x;
            this.data.forEach((y) => {
              let group = this.fb.group({
              ...
              group.addControl(
                'eenheidsPrijs',
                this.fb.control(y.eenheidsPrijs)
              );
              group.addControl(
                'dagVanDeWeekId',
                this.fb.control(y.dagVanDeWeekId)
              );
        ...
        break;
      case 'elektriciteitTarief':
        this.tariefService.getElektriciteitTarieven().subscribe(
          (x) => {
            this.data = x;
            this.data.forEach((y) => {
              let group = this.fb.group({
    ...
    data.forEach((code) => {
      ...
      switch (this.code) {
        ...
        case 'dieptekavelsapmateriaalcode':
          group.addControl(
            'dieptekavelStatusId',
            this.fb.control((<any>code).dieptekavelStatusId)
          );
          break;
        case 'elektriciteitsapmateriaalcode':
          group.addControl(
            'elektriciteitId',
            this.fb.control((<any>code).elektriciteitId)
          );
          break;
        case 'standplaatssapmateriaalcode':
    ...
    switch (this.code) {
      ...
      case 'standplaatsTarief':
        ...
        this.tariefService.saveStandplaats(payload).subscribe(
          () => {
            this.toastr.success(
              'Standplaats succesvol opgeslagen',
              'Standplaats'
            );
            this.resetForm();
          },
      ...
      case 'elektriciteitTarief':
        ...
        this.tariefService.saveElektriciteit(payload).subscribe(
          () => {
            this.toastr.success(
              'Elektriciteit succesvol opgeslagen',
              'Elektriciteit'
            );
            this.resetForm();
          },
  ...
  delete(itemId: number): void {
    switch (this.code) {
      ...
      case 'product':
        ...
        break;
      default:
        this.codeService.delete(this.code, itemId).subscribe(
          () => {
          ...
          (x) => {
            this.toastr.warning(
              this.code + ' kon niet verwijderd worden',
              this.code
            );
