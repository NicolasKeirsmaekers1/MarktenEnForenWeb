...
@Component({
    ...
    providers: [
        { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => CodeSelectComponent), multi: true }
    ],
    template: `
...
export class CodeSelectComponent implements OnInit, OnChanges, ControlValueAccessor {
    private data: ICode[];
