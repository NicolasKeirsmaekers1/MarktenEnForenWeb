...
@NgModule({
  declarations: [DocumentUploadComponent, DocumentPanelComponent],
  imports: [
    CommonModule,
    FormsModule,
    SharedModule,
  ...
  exports: [DocumentUploadComponent, DocumentPanelComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class DocumentUploadModule {
  static forRoot(): ModuleWithProviders<DocumentUploadModule> {
    return {
