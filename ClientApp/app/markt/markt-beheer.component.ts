...
export class MarktBeheerComponent {
    ...
    delete(marktId: number): void {
        this.marktService.delete(marktId)
            .subscribe(() => {
                this.fetchData(this.page);
            }, (error) => {
                this.toastr.warning("Deze markt kan niet verwijderd worden omdat er momenteel lopende aanvragen en / of abonnementen voor de markt zijn.", "Markt");
            });
    }
